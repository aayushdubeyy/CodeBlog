  ...
  return (
    <>
      <div className="flex justify-center pt-8 px-5 md:px-0">
        <div className="max-w-screen-lg w-full flex flex-col gap-8 justify-center">
          <input
            onChange={(e) => {
          ...
          />
          <button
            onClick={id ? editHandler : publishHandler}
            type="submit"
            className="inline-flex w-fit items-center px-5 py-2.5 text-sm font-medium text-center text-white bg-blue-700 rounded-lg focus:ring-4 focus:ring-blue-200"
          >
